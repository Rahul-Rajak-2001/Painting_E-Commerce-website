...
<ul class="dropdown cty">
    ...
    <li>
      ...
      <li><a href="nature.jsp">Water Colour</a></li>
</ul>
</li>
...
<div class="container">
    ...
    <form action="admin-login.jsp" method="post">
        ...
        <input type="email" id="email" name="t1" required>

        <label for="password">Password:</label>
        <input type="password" id="password" name="t2" required>

<!--        <div class="forgot-password">
            <a href="forget_password_seller.jsp" style="margin-top: 5PX; text-decoration: none; color: black;">Forgot Password?</a>
        </div>
        <div class="new-user">
            <a href="seller signup.jsp" style="margin-top: 3PX;text-decoration: none; color: black;">New User?</a>
        </div>-->
    ...
    <%
        try
           ...
           if("admin@gmail.com".equals(uid) && "rahul".equals(p))
            {
