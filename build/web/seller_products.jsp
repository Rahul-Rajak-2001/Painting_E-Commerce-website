...
<html>
<head>
    <!-- Add necessary meta tags, title, and external CSS/JS files if needed -->
    <title>Seller Paintings</title>
        ...
        <div class="seller-details">
            <% 
                ...
                try {
                    ...
                    String sellerInfoSql = "select * from seller where seller_id = ?";
                    PreparedStatement sellerInfoPst = con.prepareStatement(sellerInfoSql);
                    sellerInfoPst.setString(1, sellerId);
                    ResultSet sellerInfoRs = sellerInfoPst.executeQuery();
                    if(sellerInfoRs.next()) {
                        // Get seller details
                        String sellerImage = sellerInfoRs.getString("image");
                        String sellerName = sellerInfoRs.getString("seller_name");
                        String sellerAddress = sellerInfoRs.getString("address");
                        // Count total paintings for this seller
                        String paintingCountSql = "select count(*) as total_paintings from painting where seller_id = ?";
                        PreparedStatement paintingCountPst = con.prepareStatement(paintingCountSql);
                        paintingCountPst.setString(1, sellerId);
                        ResultSet paintingCountRs = paintingCountPst.executeQuery();
                        int totalPaintings = 0;
                        if(paintingCountRs.next()) {
                            totalPaintings = paintingCountRs.getInt("total_paintings");
                        }
            %>
                <!-- Display seller image -->
                <img src="images/<%=sellerImage%>" alt="<%=sellerName%>" height="150" width="150">
                <div class="seller-info-text">
                    <!-- Display seller name -->
                    <h3 style="font-size: 35px;"><%=sellerName%></h3>
                    <!-- Display seller address -->
                    <p><i class="fa-solid fa-location-dot" id="address"></i> <%=sellerAddress%></p>
                    <!-- Display total paintings -->
                    <p> &nbsp;|&nbsp;Total Paintings: <%=totalPaintings%></p>
                </div>
    ...
    <div class="product-container">
        ...
        %>
                    <div class="product-card">
                        <!-- Product image -->
                        <a href="single_product.jsp?painting_id=<%=rs.getString(1)%>">
...
<footer>
    ...
    <!-- Add necessary script tags if needed -->
   <script>
