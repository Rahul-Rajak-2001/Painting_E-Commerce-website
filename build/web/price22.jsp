...
%>
    ...
    <%
        try {
            ...
            String sql1 = "SELECT * FROM painting WHERE price BETWEEN 999 AND 1499 LIMIT 4";
            PreparedStatement pst1 = con.prepareStatement(sql1);
            ResultSet relatedRs = pst1.executeQuery();
            while(relatedRs.next()) {
    %>
                <div class="related-product-card">
                    <a href="price22.jsp?painting_id=<%=relatedRs.getString(1)%>" style="text-decoration: none;">
