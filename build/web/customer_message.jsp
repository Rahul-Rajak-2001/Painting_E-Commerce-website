      ...
      <div class="contain">
        ...
        <table id="userTable">
            ...
            try {
                ...
                String sql= "SELECT cust_id, customer_name, message FROM message WHERE (cust_id, timestamp) IN (SELECT cust_id, MAX(timestamp) FROM message GROUP BY cust_id)";
            ...
            %>
            <tr>
                <td><a href="admin.jsp?cust_id=<%= cust_id %>"><%= cust_id %></a></td>
                <td><%= rs.getString("customer_name") %></td>
                <td><a href="admin.jsp?cust_id=<%= cust_id %>"><%= rs.getString("message") %></a></td>
            </tr>
            <% 
                }
                con.close();
