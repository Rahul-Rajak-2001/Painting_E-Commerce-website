...
%>
        ...
        <% 
            try {
                ...
                String sql1 = "SELECT * FROM painting WHERE category_name = 'Study room' LIMIT 4";
                PreparedStatement pst1 = con.prepareStatement(sql1);
                ResultSet relatedRs = pst1.executeQuery();
                while(relatedRs.next()) {
        %>
                    <div class="related-product-card">
                        <a href="study_room_related.jsp?painting_id=<%=relatedRs.getString(1)%>" style="text-decoration: none;">
