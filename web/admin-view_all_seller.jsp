...
table {
    ...
    margin: 0;
    flex: 1;
    table-layout: auto; /* Changed to 'auto' for better column width adjustment */
}
th, td {
    padding: 10px;
    text-align: left;
        ...
        <div class="table-container">
          <table id="userTable">
            ...
            try {
                ...
                String sql= "select seller_id, image, seller_name, contact_no, email, state, city, address, pincode from seller";
            ...
            <tr>
                ...
                <td><img src="images/<%= rs.getString(2) %>" alt="Painting Image" style="max-width: 150px;"></td>
                ...
                <!-- Add View Paintings link -->
               
                <td><i class="fas fa-eye view-paintings-icon" onclick="viewPaintings('<%= seller_id %>')"></i></td>
            </tr>
            <% 
                }
                con.close();
   ...
   <script>
        function deleteRow(seller_id) {
            if (confirm("Are you sure you want to delete this user?")) {
                window.location.href = "Admin_delete_seller.jsp?seller_id=" + seller_id;
            }
        }
        
        
        
          function viewPaintings(seller_id) {
            // Redirect to a page where admin can view all paintings associated with the seller
            window.location.href = "View_particular_seller_Paintings.jsp?seller_id=" + seller_id;
        }
    </script>
</body>
</html>