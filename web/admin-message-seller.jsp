...
<body>
    ...
    <main>
      ...
      <div class="chat-container">
        ...
        <div class="input-container">
          <form action="admin-message-seller.jsp" method="post">
      ...
      if ("POST".equalsIgnoreCase(request.getMethod())) {
          try {
              ...
              // Get seller_name from sellermessage table
              String getSellerNameSql = "SELECT seller_name FROM sellermessage WHERE seller_id = ?";
              PreparedStatement getSellerNamePst = con.prepareStatement(getSellerNameSql);
              getSellerNamePst.setInt(1, sellerId);
              ResultSet getSellerNameRs = getSellerNamePst.executeQuery();
              String sellerName = "";
              if (getSellerNameRs.next()) {
                  sellerName = getSellerNameRs.getString("seller_name");
              }

              String insertSql = "INSERT INTO adminmessageseller (seller_id, seller_name, message) VALUES (?, ?, ?)";
              PreparedStatement insertPst = con.prepareStatement(insertSql);
              insertPst.setInt(1, sellerId);
              insertPst.setString(2, sellerName);
              insertPst.setString(3, message);
              int rowsAffected = insertPst.executeUpdate();
              if (rowsAffected > 0) {
                  response.sendRedirect("admin-message-seller.jsp?seller_id=" + sellerId);
              }
              con.close();
          } catch (Exception e) {
              out.println(e);
  ...
  <script>
    function getMessages1() {
        var sellerId = <%= request.getParameter("seller_id") %>;
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "get_messages1.jsp?seller_id=" + sellerId, true);
