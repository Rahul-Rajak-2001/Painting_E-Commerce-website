...
<!-- Dashboard content -->
 ...
 <div class="contain">
        <h2> Add Painting</h2>
      <form action="AddProduct" method="post" enctype="multipart/form-data" onsubmit="return showConfirmation();">
           ...
           <%
			...
			Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/painting","root","passord.9506");
                       String str1=(String)session.getAttribute("e");
                        String sql1="select seller_id from seller where email = '"+str1+"'";
              ...
              <label for="seller_name">Id:</label>
                                <input type="number" id="seller_name" name="seller_id" value="<%=rs1.getInt(1)%>"
                                     readonly style="cursor:not-allowed;" required>
            
<% }  %>
            
             <label for="name"> Painting Name:</label>
            <input type="text" id="name" name="painting_name" required>
            <label for="seller_image">Upload Image:</label>
            <input type="file" id="seller_image" name="image" required>
            

            <label for="name"> Quantity:</label>
            <input type="text" id="name" name="qty" required><!-- comment -->
            ...
            <input type="number" id="Address" name="price" required>
              <label for="confirm_password">Category Name:</label>
        ...
        <%
			...
			Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/painting","root","passord.9506");
                        ...
                        {
                      %>
                      <option><%=rs2.getString("category_name")%></option>
                      <%
            }
