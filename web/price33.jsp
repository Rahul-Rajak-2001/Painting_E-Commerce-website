...
%>
    ...
    <%
        try {
            ...
            // Fetch paintings with prices between ₹599 and ₹1999
            String sql1 = "SELECT * FROM painting WHERE price BETWEEN 1499 AND 1999 LIMIT 4";
            PreparedStatement pst1 = con.prepareStatement(sql1);
            ResultSet relatedRs = pst1.executeQuery();
            while(relatedRs.next()) {
    %>
                <div class="related-product-card">
                    <a href="price33.jsp?painting_id=<%=relatedRs.getString(1)%>" style="text-decoration: none;">
