   ...
   <%
                ...
                %>
                    ...
                    <div id="popup" class="popup">
                        <div class="popup-content">
                            ...
                            <button class="confirm-btn" onclick="redirectToAnotherPage()">ok</button>
                        </div>
                    </div>

                    <script>
                        // JavaScript to open the pop-up box
    ...
    <form action="customer_login.jsp" method="post">
        ...
        <div class="forgot-password">
            <a href="forgetPassword.jsp" style="margin-top: 5PX; text-decoration: none; color: black;">Forgot Password?</a>
        </div>
        <div class="new-user">
            <a href="c_signup.jsp" style="margin-top: 3PX;text-decoration: none; color: black;">New User?</a>
        </div>
