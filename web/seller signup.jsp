...
.back-btn:hover {
  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="AddSellerImage" method="post"  name="f1" onsubmit="return show()" enctype="multipart/form-data">
            ...
            <input type="text" id="name" name="seller_name" required><!-- comment -->
