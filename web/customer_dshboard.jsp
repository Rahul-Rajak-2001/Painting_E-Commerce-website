...
<!-- Dashboard content -->
        ...
        <%
              session.setAttribute("customerId", customerId); // Set the customer ID in the session
        %>
            ...
            <nav>
              <ul>
                ...
                <li><a href="customer.jsp?cust_id=<%= customerId %>"><i class="fas fa-comments"></i>Messages</a></li>
          ...
          <main>
            ...
            <div class="profile-container">
              ...
              <div class="profile-info">
                <span>Name: </span><span><%= rs.getString("customer_name") %></span>
                <span>Email: </span><span><%= rs.getString("email") %></span>
                <span>Mobile No.: </span><span><%= rs.getString("mobile_no") %></span>
                <span>Address: </span><span><%= rs.getString("address") + ", " + rs.getString("city") + ", " + rs.getString("state") + ", -" + rs.getInt("pincode") %></span>
              </div>
            </div>
