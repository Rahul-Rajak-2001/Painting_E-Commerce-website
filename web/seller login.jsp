        ...
        if (sessEmail != null) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    // Show alert and open the pop-up
                ...
                // Handle exception
                out.println("Error: " + m.getMessage());
            }
        }
    %>

    <form action="seller login.jsp" method="post">
        ...
        <div class="new-user">
            <a href="seller signup.jsp" style="margin-top: 3PX;text-decoration: none; color: black;">New Seller?</a>
        </div>
