...
<%
    ...
    try {
        ...
        if(rs.next()) {
            availableQuantity = rs.getInt("quantity"); // Get the available quantity from the database
...
%>
                ...
                <div class="related-products-container">
                    ...
                    sql = "select * from painting where seller_id = ? and painting_id != ? limit 4";
                    pst = con.prepareStatement(sql);
                    pst.setString(1, rs.getString(2)); // Set the seller ID
                    pst.setString(2, productId);
                    ResultSet relatedRs = pst.executeQuery();
                      
                        while(relatedRs.next()) {
                    %>
                            <div class="related-product-card">
                                <a href="Sonika_Agarwal_Related_Paintings.jsp?painting_id=<%=relatedRs.getString(1)%>" style="text-decoration: none;">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function increaseQuantity(availableQuantity) {
